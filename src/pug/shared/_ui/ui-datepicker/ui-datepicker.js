...
export default function uiDatepicker() {
	...
	// datepicker init
	const datepickersSingle = document.querySelectorAll('.ui-datepicker_single')
	const datepickersRange = document.querySelectorAll('.ui-datepicker_range')
	const datepickersTime = document.querySelectorAll('.ui-datepicker_time')
